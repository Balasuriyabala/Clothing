                    ...
                    <div className="bg-white rounded-lg p-6 w-full max-w-2xl max-h-[90vh] overflow-y-auto">
                      ...
                      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <div className="space-y-4">
                          ...
                          {(newProduct.category === 'shirts' || newProduct.category === 'tshirts') && (
                            <div>
                              <label className="block text-sm font-medium text-gray-700 mb-2">
                                Sleeve Type *
                              </label>
                              <select
                                value={newProduct.sleeveType || 'full-sleeve'}
                                onChange={(e) => setNewProduct(prev => ({ ...prev, sleeveType: e.target.value as any }))}
                                className="w-full px-3 py-2 border border-gray-300 rounded-md focus:outline-none focus:ring-2 focus:ring-black"
                              >
                        ...
                        <tr key={product.id} className="hover:bg-gray-50">
                          ...
                          <td className="px-6 py-4 whitespace-nowrap">
                            {product.sleeveType ? (
                              editingProduct === product.id ? (
                                <select
                                  value={editForm.sleeveType || product.sleeveType}
